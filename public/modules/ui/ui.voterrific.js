...
// </accordion-group>
.directive('voterrificAccordionHeading', function() {
  return {
    restrict: 'EA',
    transclude: true,   // Grab the contents to be used as the heading
    template: '',       // In effect remove this element!
    replace: true,
    require: '^voterrificAccordionGroup',
    scope: {
      row: '='
    },
...
//   ...
// </div>
.directive('voterrificAccordionTransclude', [ '$compile', function($compile) {
  return {
    require: '^voterrificAccordionGroup',
    link: function(scope, element, attr, controller) {
      scope.$watch(function() { return controller[attr.voterrificAccordionTransclude]; }, function(heading) {
        if ( heading ) {
          element.html('');
